...
use Sdk\Interaction\Complaint\Translator\ComplaintRestfulTranslator;

class ComplaintRestfulAdapter extends CommonRestfulAdapter implements IComplaintAdapter
{
    ...
    {
        parent::__construct(
            new ComplaintRestfulTranslator(),
