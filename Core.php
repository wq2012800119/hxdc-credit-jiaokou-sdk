...
class Core extends MarmotCore
{
    ...
    protected function initAutoload()
    {
        ...
        //     function ($className) {
        //         $file = str_replace(['\\','Marmot/Application/'], ['/','',''], $className) . '.php';
        ...
        //         }
        //         //加载 ut 测试文件
        //         $unitTestFile = $this->getAppPath().'tests/unitTest/src/'.$file;
        ...
        spl_autoload_register(
            function ($className) {
                $file = str_replace(['\\','Sdk/','Sdk'], ['/','',''], $className) . '.php';
                ...
                //加载ut测试文件
                $mockTestFile = $this->getAppPath().'tests/mock/'.$file;
                if (file_exists($mockTestFile)) {
                    include_once $mockTestFile;
                }
